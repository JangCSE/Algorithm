...
void MergeSort(int DataSet[], int StartIndex, int EndIndex) 
{
	...
	MiddleIntdex = (StartIndex + EndIndex) / 2;

	MergeSort(DataSet, StartIndex, MiddleIntdex);
	MergeSort(DataSet, MiddleIntdex + 1, EndIndex);

	Merge(DataSet, StartIndex, MiddleIntdex, EndIndex);
}
